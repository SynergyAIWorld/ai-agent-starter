...
import { ModelClass, ModelProviderName, TokenizerType } from "./types";
...
export async function generateText({
  ...
  elizaLogger.log("Generating text...", runtime.modelProvider);
  ...
  try {
    ...
    switch (provider) {
      ...
      case ModelProviderName.DEEPSEEK: {
        ...
        const deepseek = createOpenAI({ apiKey, baseURL: serverUrl });
